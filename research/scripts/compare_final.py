...
def main():
    ...
    # 使用者提出的新配置
    t_new = np.array([0.40, 0.30, 0.15, 0.15])
    ...
    print("=" * 70)
    print("        [ 原配置: 50/20/15/15 ]  |  [ 新配置: 40/30/15/15 ]")
    print("股票總計:         100%           |           100%")
    print(" ├ 美股 (SPY) :    65%           |            69%  <-- 美股比例上升")
    print(" └ 國際股(EFA):    35%           |            31%  <-- 國際比例下降")
    print("----------------------------------------------------------------------")
    print("債券總計:          50%           |            40%  <-- 成功降低債券曝險")
    print("趨勢期貨:          35%           |            45%  <-- 成功提升管理期貨")
    print("信貸收益:          15%           |            15%")
    print("總曝險  :         200%           |           200%")
    
    print("\n" + "=" * 70)
    print("【 蒙地卡羅壓力測試對比 (3000次歷史重抽樣) 】")
    print("=" * 70)
    print(f"                       [ 原配置 ]          |  [ 40/30/15/15 ]")

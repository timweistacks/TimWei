...
(function initPersonalLedgerLocale(global) {
  ...
  const STRINGS = {
    ...
    "viz.section_title": { en: "Return Stacking breakdown", zh: "Return Stacking 策略拆解" },
    "viz.link.learn": {
      en: "New to this chart? Start with Return Stacking basics",
      zh: "不懂這張圖？先看 Return Stacking 概念",
    },
    "viz.link.etfs": { en: "Full ETF guide", zh: "各檔 ETF 完整說明" },
    "viz.aria.stack_chart": {
      en: "Return Stacking dual-layer exposure donut chart",
      zh: "Return Stacking 雙層曝險比例同心圖",
    },
    "viz.aria.legend_core": { en: "Equity exposure legend", zh: "股票部位圖例" },
    "viz.aria.legend_alt": { en: "Alt and bond exposure legend", zh: "替代與債券圖例" },
    ...
    "spy.day_ahead": { en: "Beat market yesterday by {n}", zh: "昨日贏大盤 {n}" },
    "spy.day_behind": { en: "Trailed market yesterday by {n}", zh: "昨日輸大盤 {n}" },
    ...
    "th.deviation": { en: "Deviation", zh: "偏離" },
    ...
    "meta.live_days": { en: "Day {day} / 20 Years", zh: "第 {day} 天 / 20年" },
